...
public class ClassRoom {
	...
	public ClassRoom(int classId, int gakkaId, int senkouId, String className, int gakunen, int kyouinId) {
	...
	public ClassRoom(int classId, String className, int kyouinId) {
		this.classId = classId;
		this.className = className;
		this.kyouinId = kyouinId;
	}
